...
Requirements:
    pip install numpy matplotlib pyvista botocore[boto3] arm_pyart
...
class Radar3DVisualizer:
    ...
    def create_3d_plot(
        ...
        reflectivity = grid.fields['reflectivity']['data'].data
        x = grid.x['data']
        y = grid.y['data']
        z = grid.z['data']
